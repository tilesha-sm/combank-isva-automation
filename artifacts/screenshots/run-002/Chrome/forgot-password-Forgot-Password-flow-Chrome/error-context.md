...
```
Error: OTP not found in Gmail for forgot-password flow
```
...
- generic [ref=e2]:
  ...
  - generic [ref=e14]:
    ...
    - generic [ref=e18]:
      - img "Email OTP Icon" [ref=e20]
      - heading "Enter the 6 digit code" [level=2] [ref=e21]
      - paragraph [ref=e22]:
        - text: A one time PIN has been sent
        - generic [ref=e23]: to your registered E-mail
        - strong [ref=e24]: tile*****@ncinga.net
        - text: is valid only for 2min
      - generic [ref=e25]: "OTP Reference Number : 4390"
      - generic [ref=e27]:
        - textbox [active] [ref=e28]
        - textbox [disabled] [ref=e29]
        - textbox [disabled] [ref=e30]
        - textbox [disabled] [ref=e31]
        - textbox [disabled] [ref=e32]
        - textbox [disabled] [ref=e33]
      - generic [ref=e34]:
        - generic [ref=e36]:
          - text: Any Problem?
          - button "Log in another way" [ref=e37] [cursor=pointer]
        - button "Resend OTP" [ref=e40] [cursor=pointer]
    - generic:
